    ...
    <div class="w-full flex flex-col gap-4 mb-4 overflow-hidden">
        ...
        <template v-else>
            ...
            >
                ...
                <UButton
                    v-if="!isPages"
                    class="bg-accent-blue text-white border-[1.5px] border-dark shadow-[2px_2px_0px_border-dark] px-4 py-3 rounded-lg flex flex-col items-center justify-center hover:bg-primary transition-colors"
                    @click="handleWallet()"
                >
            ...
            <div
                v-else
                class="bg-white border-[1.5px] border-dark shadow-[4px_4px_0px_border-dark] rounded-xl py-12"
            >
                <div
